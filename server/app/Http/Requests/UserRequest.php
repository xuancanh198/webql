...
class UserRequest extends BaseRequest
{
    ...
    public function attributes()
    {
        ...
        return array_merge($attributes, [
           'username' => trans('validation.usernameUser'),
            'fullname' => trans('validation.fullnameUser'),
            'address' => trans('validation.addressUser'),
            'identificationCard' => trans('validation.identificationCardUser'),
            'email' => trans('validation.emailUser'),
            'phoneNumber' => trans('validation.phoneNumberUser'),
            'note' => trans('validation.noteUser'),
            'dateOfBirth' => trans('validation.dateOfBirthUser'),
            'dateIssuanceCard' => trans('validation.dateIssuanceCardUser'),
            'placeIssue' => trans('validation.placeIssueUser'),
            'image' => trans('validation.imageUser'),
            'password' => trans('validation.passwordUser'),
            'passwordDefaultUser' => trans('validation.passwordDefault'),
        ]);
    }    
}
